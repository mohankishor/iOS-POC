...
//
//
// Changed getSubImageAtPoint to also set the flipHorizontal and flipVertical params correctly
...
@synthesize vertices;
@synthesize rotationOriginOffset;
...
- (void)initImplementation {
	...
	rotationOriginOffset = CGPointMake(0, 0);
...
- (void)renderAt:(CGPoint)point texCoords:(Quad2f*)tc quadVertices:(Quad2f*)qv {
	...
	glTranslatef((point.x+rotationOriginOffset.x), (point.y+rotationOriginOffset.y), 0);
