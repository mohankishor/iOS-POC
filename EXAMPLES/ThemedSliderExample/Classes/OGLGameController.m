...
- (id)init {
	...
	if(self == [super init]) {	
		...
		scene = [[SplashScene alloc] init];
		[_director addSceneWithKey:@"splash" scene:scene];
		[scene release];
		...
		[_director setCurrentSceneToSceneWithKey:@"splash"];
		[[_director currentScene] setSceneState:kSceneState_Running];
