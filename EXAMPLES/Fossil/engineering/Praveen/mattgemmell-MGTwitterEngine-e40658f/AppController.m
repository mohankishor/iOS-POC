...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    NSString *username = @"sbfossil";
    NSString *password = @"sbfossil123";
	
	NSString *consumerKey = @"sU8sOyNIqfPBM5gV75JPw";
	NSString *consumerSecret = @"7IBnIRFsxqYZ1BCQZYWKzYAs6a3bwTIqjSl9py2EDs";
	...
	NSLog(@"token %@", [twitterEngine getXAuthAccessTokenForUsername:username password:password]);
	NSLog(@"444");
}
